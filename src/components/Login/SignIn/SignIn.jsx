                ...
                <div className='h-150 w-280 lg:bg-gray-300 rounded-2xl flex'>
                    ...
                    <div className='w-[90vw] mx-auto lg:w-1/2 h-full bg-white rounded-2xl flex items-center justify-center text-black' >
                        <div className="w-full max-w-sm p-6 bg-white rounded-lg ">
                            <h2 className="text-5xl font-semibold text-center text-gray-800">Sign In</h2>
                            ...
                            <form className="mt-4" onSubmit={handleSubmit}>
                                ...
                                <button className="w-full px-4 py-2 mt-4 font-semibold text-white bg-gray-800 rounded-lg hover:bg-blue-600" type="submit" onClick={handleSubmit}>Login</button>
                            </form>
                    ...
                    <div className='w-1/2 h-full bg-gray-800 rounded-r-2xl hidden lg:flex flex-col items-center justify-center gap-20'>

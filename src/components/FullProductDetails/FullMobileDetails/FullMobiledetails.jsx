        ...
        <>
            {
                mobilesData.mobilesData?.products[Index] ? (
                    <div className={`fullMobileData flex flex-col items-center justify-center xl:flex-row lg:pb-20 xl:pb-5
                        ...
                        <div className=' w-screen xl:w-[40vw] flex overflow-hidden pt-5 xl:p-20 justify-center items-center flex-col'>
                            <div className='flex flex-col h-[40vh] justify-center gap-5 xl:justify-between items-center p-10 rounded-2xl mt-10 xl:mt-0  xl:h-[70vh] '>
                                <div className='bg-blue-300 h-[30vh] w-[80vw] xl:w-[30vw] flex justify-center items-center rounded-2xl xl:h-[50vh]'>
                                    <img src={viewFullMobileImage ? (viewFullMobileImage) : (fullMobilesData.images[0])} alt="" className='h-[27vw] xl:h-70 xl:w-auto' />
                                </div>
                            ...
                            <div className={`xl:bg-transparent h-auto w-screen p-3 fixed bottom-0 xl:relative xl:h-30 xl:w-[40vw] flex items-center justify-evenly gap-2 sm:gap-0 
                                ...
                                <button className='bg-yellow-500 h-13 w-[45vw] xl:w-50 rounded-xl cursor-pointer text-xl font-bold flex justify-center items-center gap-3 hover:border-2 text-black' onClick={() => buyNow(fullMobilesData.price, fullMobilesData)}> <i className="fa-solid fa-money-check"></i> Buy Now</button>
